...
export const metadata: Metadata = {
  title: "Application Rejected — Medicare",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
        ...
        <h1 className="text-2xl font-black text-slate-900 mb-2">Application Rejected</h1>
        <p className="text-slate-500 text-sm leading-relaxed mb-2">
          Your portal application has been reviewed and was not approved at this time.
        </p>
        <p className="text-slate-400 text-xs leading-relaxed mb-8">
          You may still use the standard user dashboard. If you believe this decision
          was made in error, please contact support.
        </p>
